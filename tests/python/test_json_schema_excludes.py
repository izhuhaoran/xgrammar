...
def test_cohere_excludes_are_not_silently_ignored():
    schema = {"type": "object", "properties": {"value": {"type": "string"}}}
    xgr.Grammar.from_structural_tag(schema_tag(schema, "cohere_xml", excludes=[]))
    with pytest.raises(RuntimeError, match="excludes is not supported for cohere_xml"):
        xgr.Grammar.from_structural_tag(schema_tag(schema, "cohere_xml"))
